...
/*            const markers = new google.maps.Marker({
               position: { lat: parseFloat(marker.geo.lat), lng: parseFloat(marker.geo.lng) },
               map,
               title: marker.name,
               icon: pinImage,
...
//
//    let arr = time.replace(/ +?/g, '').match(/^(0?[1-9]|1[012]):([0-5][0-9])([APap][mM])$/);
//
...
// function checkDates() {
//
//    if ((jQuery('#timeFrom').val() == '') || (jQuery('#timeTo').val() == '')) return;
//
//    if(jQuery('#btn-check-2').is(':checked') || jQuery('#btn-check-3').is(':checked') || jQuery('#btn-check-4').is(':checked')
//       || jQuery('#btn-check-5').is(':checked') || jQuery('#btn-check-6').is(':checked') || jQuery('#btn-check-7').is(':checked')
//       || jQuery('#btn-check-8').is(':checked'))
//    {
//       var start = timeToInt(jQuery('#timeFrom').val());
//       var end = timeToInt(jQuery('#timeTo').val());
//    }
//
//
//    if ((start == -1) || (end == -1)) {
...
//
//    if (start > end) {
//       jQuery('#timeerrorMsg').css("display","block");
//    }
// }
